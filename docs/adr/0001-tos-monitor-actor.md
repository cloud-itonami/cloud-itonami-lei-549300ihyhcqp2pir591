...
This repository archives the publicly published Terms of Use of GATX
...
- **Company**: GATX Corporation, LEI 549300IHYHCQP2PIR591, website
  `https://www.gatx.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.gatx.com/terms-of-use/`,
  retrieved-at `2026-07-10T07:21:00Z`, doc-type `:terms-of-service`.
