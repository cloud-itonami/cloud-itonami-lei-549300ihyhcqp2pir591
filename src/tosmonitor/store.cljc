(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (GATX Corporation, LEI
  549300IHYHCQP2PIR591) -- unlike `commitledger.store`'s multi-application
...
(defn demo-company []
  {:legal-name "GATX Corporation"
   :website    "https://www.gatx.com"})

(def ^:private demo-full-text
  "Terms of Use\nThese Terms of Use govern your access to and use of the GATX Corporation website. By using this site you agree to these Terms, which are subject to change without notice. This agreement is governed by the laws of the State of New York.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.gatx.com/terms-of-use/"
   :retrieved-at "2026-07-10T07:21:00Z"
